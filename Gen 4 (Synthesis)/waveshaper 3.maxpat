...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 754.0, 155.0, 89.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 643.0, 377.0, 68.0, 22.0 ],
					"text" : "r resolution"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 583.5, 476.5, 64.0, 22.0 ],
					"text" : "poke~ test"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 590.0, 377.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 583.5, 414.0, 78.0, 22.0 ],
					"text" : "count~ 0 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 583.5, 445.0, 148.0, 22.0 ],
...
,
					"patching_rect" : [ 450.0, 480.0, 79.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 543.0, 155.0, 71.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 109.0, 392.776734000000033, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 543.0, 118.0, 51.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 258.0, 167.0, 51.0, 22.0 ],
					"style" : "numberGold",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 893.0, 164.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 601.5, 236.0, 151.0, 117.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 450.0, 520.0, 136.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 581.0, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 68.0, 419.0, 383.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 77.5, 381.0, 77.5, 381.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 118.5, 381.0, 118.5, 381.0 ],
					"source" : [ "obj-26", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 488.75, 577.0, 485.5, 577.0 ],
					"source" : [ "obj-43", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 459.5, 568.0, 459.5, 568.0 ],
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 459.5, 505.0, 576.5, 505.0 ],
					"order" : 0,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 459.5, 505.0, 459.5, 505.0 ],
					"order" : 1,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 552.5, 143.0, 552.5, 143.0 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 593.0, 468.0, 593.0, 468.0 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 593.0, 438.0, 593.0, 438.0 ],
					"order" : 1,
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 593.0, 438.0, 579.0, 438.0, 579.0, 468.0, 615.5, 468.0 ],
					"order" : 0,
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 599.5, 402.0, 593.0, 402.0 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 212.833333333333343, 318.0, 54.0, 318.0, 54.0, 279.0, 77.5, 279.0 ],
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 652.5, 402.0, 652.0, 402.0 ],
					"source" : [ "obj-81", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 763.5, 213.0, 879.0, 213.0, 879.0, 159.0, 902.5, 159.0 ],
					"source" : [ "obj-82", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-82" : [ "live.dial[1]", "Modulus Period", 0 ],
			"parameterbanks" : 			{
